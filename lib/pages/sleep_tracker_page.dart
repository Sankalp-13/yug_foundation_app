...
class _SleepTrackerPageState extends State<SleepTrackerPage> {
  ...
  Future<void> _showNotification() async {
    ...
    await flutterLocalNotificationsPlugin.show(
        notiID, 'Time for bed', 'Follow your schedule for a healthy sleep!', notificationDetails,
        payload: 'item x');
  }
        ...
        child: BlocConsumer<SleepTrackerCubit, SleepTrackerState>(
            ...
            builder: (context, state)  {
              ...
              if(state is SleepTrackerSleepingState){
                return Column(
                  ...
                  children: [
                    ...
                    Lottie.asset('assets/sleeping.json',height: screenWidth * 0.9,),
                    ElevatedButton(
              ...
              if(state is SleepTrackerLoadedState){
                ...
                double max = state.userSleep.days.reduce((curr, next) => curr > next? curr: next);///max value calc
                ...
                return Column(
                  ...
                  children: [
                    ...
                    RichText(
                      textAlign: TextAlign.center,
                      text: TextSpan(
                        text: count !=0?'Your average sleep\neveryday is ': "Let's start tracking your sleep hours!",
                        style: Theme.of(context).textTheme.titleLarge,
                        children: <TextSpan>[
                          TextSpan(
                              text: count !=0?'$sum': '',
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      BlocProvider.of<SleepTrackerCubit>(context).goToSleep(DateTime.now());
                                    },
